...
//update: (executed on app start and on every app operation)
// interpolate template with data 
// render result in the menu div

//add function: (executed when the user clicks submit)
//parse input value 
// create object
// sent POST request with object
// on succes -> add result to local list and update template result
...
async function initialize() {
    ...
    document.querySelector('form')
        .addEventListener('submit', (event) => addItem(event,list));
